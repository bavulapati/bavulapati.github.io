...
Icons are inline SVG (Ionicons 5.5.2 path data, `currentColor` so they inherit text color), not a runtime icon font - there is no longer an Ionicons or Google Maps dependency.
